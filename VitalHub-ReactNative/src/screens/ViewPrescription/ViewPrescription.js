        ...
        <ScrollView>
            <Container>
                ...
                <InputDisable
                    ...
                    placeholder={prescriptionData.descricao}
                    editable={false}
                    multiline={true}
                ...
                <InputDisable
                    fontSize={16}
                    textAlignVertical="top"
                    placeholder={prescriptionData.diagnostico}
                    editable={false}
                    multiline={true}
                    style={{ marginBottom: 20, marginTop: 8 }}
                />
                ...
                <InputDisable
                    ...
                    fontSize={16}
                    textAlignVertical="top"
                    placeholder={prescriptionData.receita.medicamento}
                    editable={false}
                    multiline={true}
                    style={{ marginBottom: 20, marginTop: 8 }}
                />
                ...
                <InputDisable
                    ...
                    placeholder={
                        prescriptionData.exames.length > 0
                            ? prescriptionData.exames[0].titulo
