...
INSERT [dbo].[TiposUsuario] ([ID], [TiposUsuario]) VALUES (newid(), 'paciente'), (newid(), N'Cardiologia')

GO
ALTER TABLE [dbo].[Usuarios] CHECK CONSTRAINT [FK_Usuarios_TiposUsuario]
GO
INSERT INTO TiposUsuario VALUES (newid(), 'paciente'), (newid(), N'Cardiologia')

Drop database VitalHub;